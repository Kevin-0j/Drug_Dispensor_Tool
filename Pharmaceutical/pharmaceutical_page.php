...
<body>
  ...
  <h1 style="margin-top: 0;">Welcome Pharmaceutical <?php echo $username; ?></h1>

  <?php if (isset($message)) { ?>
    <p><?php echo $message; ?></p>
  <?php } ?>

  <form action="pharmaceutical_page.php" method="POST" enctype="multipart/form-data" style="display: none;">
